...
public static class Wheel
{
	...
	public static void LoadContent()
	{
		...
		{
			/*ID*/field_1528 = "true-animismus-Herriman",
			/*Name*/field_1529 = class_134.method_253("Herriman's Wheel", string.Empty),
			/*Desc*/field_1530 = class_134.method_253("Herriman's Wheel can supply or receive from the Glyph of Infusion, or mediate half of the Glyphs of Animismus and Disproportion.", string.Empty),
			/*Cost*/field_1531 = 30,
